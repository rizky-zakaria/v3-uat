                ...
                <li class="menu nav-item relative">
                    <a href="javascript:;" class="nav-link">
                        <div class="flex items-center">
                            ...
                            <span class="px-2">{{ $t('Master Data') }}</span>
                        </div>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <router-link to="/master-data/requirements">{{ $t('Requirements') }}</router-link>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item relative">
                    <a href="/projects" class="nav-link">
                        <div class="flex items-center">
                            ...
                            <span class="px-2">{{ $t('Projects') }}</span>
                        </div>
                    </a>
                </li>
                <li class="menu nav-item relative">
                    <a href="documents" class="nav-link">
                        <div class="flex items-center">
                            ...
                            <span class="px-2">{{ $t('Documents') }}</span>
                        </div>
                    </a>
                </li>
            </ul>
